      ...
      {variant === "nav" ? (
        <div className="flex items-center gap-1">
          <Link
            ...
            className="flex min-w-0 flex-1 items-center gap-3 rounded-[12px] border border-transparent px-2 py-2 text-left transition-colors hover:border-white/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber"
          >
          ...
          <button
            ...
            aria-expanded={open}
            aria-label="Switch or pin North spaces"
            className="shrink-0 rounded-[10px] border border-transparent p-2.5 text-nav-muted transition-colors hover:border-white/15 hover:text-nav-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber"
          >
